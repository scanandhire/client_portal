...
import CategorySelect from 'components/app/support-desk/tickets-layout/CategorySelect';
...
const columns = [
      ...
      return (
        <Flex alignItems="center" className="position-relative py-1">
          ...
          <h6 className="mb-0">
            ...
            <Link to={paths.userProfile} className="stretched-link text-900">
              {name}
            </Link>
          </h6>
        </Flex>
  ...
  },
  {
    ...
    cell: ({ row: { original } }) => {
      ...
      return (
        <Link to={paths.eventDetailSoftwareEngineer} className="fw-semibold">
          {subject}
        </Link>
      );
    }
